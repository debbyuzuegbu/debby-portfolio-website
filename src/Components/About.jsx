  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="mt-20 md:mt-36 md:mb-36">
          ...
          <p className="text-base mt-5">
            ...
            technology and finance. However She has a keen interest in
            technology and how she can use it to solve problems. Deborah enjoys
            coding.
          </p>
          <br />
